...
- (NSString *)responseString
{
    ...
    NSString *string = [[NSString alloc] initWithBytes:[data bytes] length:[data length] encoding:[self responseEncoding]];
    NSString *resualt = [self escapeHTML:string];
    [string release];
	return resualt;
}
...
{
    NSMutableString *result = [[NSMutableString alloc] initWithString:json];
